...
if __name__ == "__main__":
    os.makedirs("docs/experiments/code_kaggle/models/multi_agent_llama/results", exist_ok=True)
    ...
    for idx, _ in enumerate(data):
        if data[idx]["image_expected"] is False:
            ...
            if os.path.exists(f"docs/experiments/code_kaggle/models/multi_agent_llama/results/{idx}.json") is False:
                for i in range(3):
                    ...
                    with open(f"docs/experiments/code_kaggle/models/multi_agent_llama/results/{idx}_{i}.json", "w") as f:
