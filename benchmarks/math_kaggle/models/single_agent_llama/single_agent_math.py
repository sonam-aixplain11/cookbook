...
if __name__ == "__main__":
    os.makedirs("docs/experiments/math_kaggle/models/single_agent_llama/results", exist_ok=True)
...
>>>>>>> bd03e8e959b40a4893eb5e75458b119e4d7c888f
            if os.path.exists(f"docs/experiments/math_kaggle/models/single_agent_llama/results/{idx}_{i}.json") is False:
                ...
                print(row["gt_answer"])
                with open(f"docs/experiments/math_kaggle/models/single_agent_llama/results/{idx}_{i}.json", "w") as f:
