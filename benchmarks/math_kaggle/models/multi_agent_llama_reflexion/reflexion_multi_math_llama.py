...
if __name__ == "__main__":
    os.makedirs("docs/experiments/math_kaggle/models/multi_agent_llama_reflexion/results", exist_ok=True)
...
=======
        for i in range(3):
>>>>>>> bd03e8e959b40a4893eb5e75458b119e4d7c888f
            if (
                os.path.exists(f"docs/experiments/math_kaggle/models/multi_agent_llama_reflexion/results/{idx}_{i}.json")
                is False
            ):
...
>>>>>>> bd03e8e959b40a4893eb5e75458b119e4d7c888f
                ...
                with open(f"docs/experiments/math_kaggle/models/multi_agent_llama_reflexion/results/{idx}_{i}.json", "w") as f:
