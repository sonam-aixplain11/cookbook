...
if __name__ == "__main__":
    os.makedirs("docs/experiments/math_kaggle/models/multi_agent_llama/results", exist_ok=True)
    ...
    for idx, row in enumerate(data):
        if os.path.exists(f"docs/experiments/math_kaggle/models/multi_agent_llama/results/{idx}.json") is False:
            for i in range(3):
                ...
                with open(f"docs/experiments/math_kaggle/models/multi_agent_llama/results/{idx}_{i}.json", "w") as f:
